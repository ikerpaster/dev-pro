...
import TableHeaderRentals from 'src/views/apps/property/rentals/list/TableHeader-Rentals'
import TableHeaderProTypes from 'src/views/apps/property/type/TableHeader-ProTypes'
import DialogDeleteRental from 'src/views/apps/property/list/DialogDeleteRental'
import AddRENTALmodel from 'src/views/apps/property/rentals/list/addRentalsModel'
    ...
    <>
      ...
      >
        ...
        <MenuItem onClick={handleRowOptionsClose} sx={{ '& svg': { mr: 2 } }}>
          ...
          <AddRENTALmodel  purpose="edit" data={data} />
        </MenuItem> 
        <MenuItem onClick={handleDelete} sx={{ '& svg': { mr: 2 } }}>

          <DialogDeleteRental id={id} data={data} />
        </MenuItem>
      </Menu>
    </>
  )
...
const UserList = ({ apiData }) => {
  ...
  let url = `${process.env.NEXT_PUBLIC_WEB_URL}/admin/rentals/all`;
...
console.log("DONEEEE:: ", data);
  ...
  const columns =  [
    ...
    {
      field: 'basicInfo.listingName',
      headerName: 'Listing Name',
      flex: 1,
      valueGetter: (params) => params.row?.basicInfo?.listingName || '',
      cellClassName: 'wrap-text',
    },

    {
      field: 'ProPurpose',
      headerName: 'Property Purpose',
      flex: 0.6,
      valueGetter: (params) => params.row?.ProPurpose || '',
      cellClassName: 'wrap-text',
    },
    {
      field: 'ProFurninshing',
      headerName: 'Property Furnishing',
      flex: 0.7,
      valueGetter: (params) => params.row?.ProFurninshing || '',
      cellClassName: 'wrap-text',
    },
    {
      field: 'ProType',
      ...
      flex: 0.6,
      valueGetter: (params) => params.row?.ProType?.name || '',
      cellClassName: 'wrap-text',
    },
    {
      field: 'ProCategory',
      ...
      flex: 0.6,
      valueGetter: (params) => params.row?.ProCategory?.name || '',
      cellClassName: 'wrap-text',
    },
    {
      ...
      headerName: 'Bedrooms',
      flex: 0.3,
      valueGetter: (params) => params.row?.basicInfo?.bedrooms || '',
      cellClassName: 'wrap-text',
    },
    {
      ...
      flex: 1,
      flex: 0.3,
      valueGetter: (params) => params.row?.basicInfo?.bathrooms || '',
      cellClassName: 'wrap-text',
    },
...
<TableHeaderRentals
          ...
          />
             ...
             {/* <AddHostExperienceModel  toggle={openModalAdmin} /> */}
