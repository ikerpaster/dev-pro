...
import TableHeaderHostExperienceInquiries from 'src/views/apps/host_experience/inquiries/TableHeader-hostExperienceInquiries'
    ...
    <Grid container spacing={6}>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          <Divider />
          <TableHeaderHostExperienceInquiries value={value} handleFilter={handleFilter} toggle={openModalAdmin} setModalOpenAdmin={setModalOpenAdmin} />
          <DataGrid
            autoHeight
            rows={store.data}
            columns={columns}
