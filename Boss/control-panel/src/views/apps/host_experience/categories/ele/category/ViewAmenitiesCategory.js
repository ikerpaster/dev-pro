...
const ViewAmenityCategory = () => {
  ...
  return (
    ...
    >
        ...
        <div onClick={() => setShow(true)} className='py-2 bg-violet-300 px-3 rounded-lg text-white cursor-pointer shadow-2xl shadow-violet-500'>
...
export default ViewAmenityCategory
