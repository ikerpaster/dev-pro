...
import GooglePlacesAutocomplete from '../../rooms/list/Tabs/locationGoogle';
// import GooglePlacesAutocomplete from './locationGoogle';


const LocationsProperty = ({setLocationInfo,locationInfo}) => {
  ...
  return (
    <div className='bg-white p-4'>
      <h2 className="text-lg font-bold mb-4">Location Info</h2>
...
export default LocationsProperty