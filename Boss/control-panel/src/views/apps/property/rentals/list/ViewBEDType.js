...
<div className='flex w-full justify-end py-3'>
           <Typography  className='bg-violet-300  p-2 rounded-lg cursor-pointer'><span className='text-white' onClick={()=>setAddPo((prev)=>!prev)}>Add  New Amenity category </span></Typography>
