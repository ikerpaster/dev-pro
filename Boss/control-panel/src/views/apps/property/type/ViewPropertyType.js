...
<div className='flex w-full justify-end py-3'>
           <Typography  className='bg-violet-300  p-2 rounded-lg cursor-pointer'><span className='text-white' onClick={()=>{setShowEdit(false);setAddPo(true);setPurpose('add')}}>Add Property Type </span></Typography>
...
<AddProTypeView data='' purpose={purpose} />
          </div>
          )}
          
           {showEdit && (
          <div className='w-full h-fit bg-gray-300x my-1'>
<AddProTypeView data={datas} purpose={purpose} />
          </div>
          )}
                ...
                >
                  ...
                  <ListItemSecondaryAction sx={{ right: 0 }}>
                      <div className="relativex flex items-center gap-2">
                        ...
                        <DialogDeleteProType id={member._id}/> 
