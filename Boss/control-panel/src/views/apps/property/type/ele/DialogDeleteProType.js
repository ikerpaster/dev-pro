...
const DialogDeleteProType = ({id}) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_WEB_URL}/admin/property-type/${id}`, {
        method: 'DELETE',
        headers: {
      ...
      const successMessage = responseData.message || 'Property Type deleted successfully';
  ...
  return (
    <Fragment>
      ...
      <Dialog fullScreen={fullScreen} open={open} onClose={handleClose} aria-labelledby='responsive-dialog-title'>
        <DialogTitle id='responsive-dialog-title'>Are You Sure You want to delete this Pro Type?</DialogTitle>
        <DialogContent>
          <DialogContentText>
...
export default DialogDeleteProType