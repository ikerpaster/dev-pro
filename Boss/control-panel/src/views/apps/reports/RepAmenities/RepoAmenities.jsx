...
const RepoAmenities = ({data}) => {
    ...
    const columns = [
...

        {
          ...
          align: 'center',
          valueGetter: (params) =>
          params.row.updatedAt ? (moment(params?.row?.createdAt).format('DD-MM-YYYY')) : '', // Access propertyName safely
          cellClassName: 'wrap-text', // Apply a class for wrapping text
        },

        {
          ...
          align: 'center',
          valueGetter: (params) =>
            params.row.updatedAt ? (moment(params?.row?.updatedAt).format('DD-MM-YYYY')) : '', // Access propertyName safely
          cellClassName: 'wrap-text', // Apply a class for wrapping text
        },
  ...
  return (
    <div>
         {data && Array.isArray(data) && data.length > 0 ? (
          ...
          <div className=''> Amenities  reports</div>
    </div>
  )
}

export default RepoAmenities