...
import { Collapse, Grid, Tab } from '@mui/material'
...
import { CallOutlined, ContactsOutlined, MessageOutlined, People, PhoneMissedOutlined } from '@mui/icons-material'
                ...
                <ListItem key={index} disablePadding sx={{ '&:not(:last-child)': { mb: 1.5 } }}>
                  ...
                  >
                    ...
                    <ListItemText
                      ...
                      primary={
                        <Typography sx={{ ...(!activeCondition ? { color: 'text.secondary' } : {}) }} className='flex justify-between items-center'>
                        <span>{contact.fullName} </span>
                        <span className='text-red-500x font-thin text-xs'>      11/28/2023  </span>
                        </Typography>
                      }
                      secondary={
                        
                           <Typography noWrap variant='body2' sx={{ ...(!activeCondition) }} >
                      <span className='text-red-500 font-thin'>   <PhoneMissedOutlined  sx={{ fontSize: '1rem' }} />   missed (2) </span>
  ...
  return (
    <div>
      ...
      >
        ...
        <Grid item xs={12} md={6} sx={{mt:4, mx:1}}>
 
      <TabContext value={value}>
  <TabList onChange={handleChange} aria-label='nav tabs example'>
    <Tab value='1' component='a' label={<MessageOutlined />} href='/drafts' onClick={e => e.preventDefault()} />
    <Tab value='2' component='a' label={<CallOutlined />} href='/trash' onClick={e => e.preventDefault()} />
    <Tab value='3' component='a' label={<ContactsOutlined />} href='/spam' onClick={e => e.preventDefault()} />
    <Tab value='4' component='a' label={<People />} href='/spam' onClick={e => e.preventDefault()} />
