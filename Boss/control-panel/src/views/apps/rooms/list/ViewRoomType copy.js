...
const ViewRoomType= () => {
  ...
  // get all positions related to the department 
    let url = `${process.env.NEXT_PUBLIC_WEB_URL}/admin/room-type/all`;
 ...
 console.log("DATA OF ROOM TYPE:: ", data);
  return (
    <div>
...
<div className='flex w-full justify-end py-3'>
           <Typography  className='bg-violet-300  p-2 rounded-lg cursor-pointer'><span className='text-white' onClick={()=>setAddPo((prev)=>!prev)}>Add  New Room Type </span></Typography>
