...
import AddnewBedType from '../ELE/addBedType';
// import AddRole from './elements/addRole';

const BedTypePOPUP = ({ isOpen, onClose }) => {
  return (
    <>
      {isOpen && (
        ...
        <div onClick={onClose} className='bg-red-400x flex justify-end items-start cursor-pointer'>
          ...
          <h2 className="text-2xl font-semibold mb-4 shadow-md py-2 px-5 shadow-gray-100 text-gray-400">Add New Bed Type</h2>
