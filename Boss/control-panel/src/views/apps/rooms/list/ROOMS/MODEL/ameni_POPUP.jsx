...
import AddnewAmenity from '../ELE/addAmenity';
// import AddRole from './elements/addRole';

const AmenityPOPUP = ({ isOpen, onClose }) => {
  return (
    <>
      {isOpen && (
        <div className="fixed inset-0 flex justify-center items-center bg-red-500x py-5">
          ...
          <div className="bg-white rounded-lg p-8  z-10   h-full overflow-hidden pb-10 w-10/12">
        ...
        <div onClick={onClose} className='bg-red-400x flex justify-end items-start cursor-pointer'>
          ...
          <h2 className="text-2xl font-semibold mb-4 shadow-md py-2 px-5 shadow-gray-100 text-gray-400">Add New Amenity</h2>
