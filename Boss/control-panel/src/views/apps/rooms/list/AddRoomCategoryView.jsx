...
const AddRoomCategoryView = ({data,purpose}) => {
...
// alert("edit");
      ...
      const handleSubmit = async () => {
        try {
          const res = await fetch(`${process.env.NEXT_PUBLIC_WEB_URL}/admin/room-category`, {
            method: 'POST',
            headers: {
          ...
          if (res.ok) {
            alert('Room Category added successfully!'); // Show success alert
          } else {
            alert('Failed to add Property Category'); // Show error alert
          }
        } catch (error) {
      ...
      const handleEdit = async () => {
        try {
          const res = await fetch(`${process.env.NEXT_PUBLIC_WEB_URL}/admin/room-category/${data._id}`, {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
            },
          ...
          if (res.ok) {
            alert('Room Category Updated successfully!'); // Show success alert
          } else {
            alert('Failed to add Property Category'); // Show error alert
          }
        } catch (error) {
...
export default AddRoomCategoryView