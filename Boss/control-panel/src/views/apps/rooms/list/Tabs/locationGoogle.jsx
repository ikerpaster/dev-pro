...
const GooglePlacesAutocomplete = ({locationInfo, setLocationInfo}) => {
  ...
  //     ...prevLocationInfo,
  //     mapAddress: [...prevLocationInfo.mapAddress, newMapAddress],
  //   }));
  // };
    ...
    <div>
      ...
      <div className="my-5 flex items-center gap-2">
        ...
        {/* <input
          ...
          value={place}
          onChange={handlePlaceChange}
          disabled // Disable input while the iframe (map) is loading
        /> */}
