      ...
      >
        ...
        >
          ...
          <Typography variant='' className='w-fit whitespace-nowrap font-bold text-xl'>
           ...
           <Typography  className='bg-violet-300  p-2 rounded-lg cursor-pointer'><span className='text-white' onClick={()=>{setShowEdit(false);setAddPo(true);setPurpose('add')}}>Add Room Type </span></Typography>
...
<AddRoomTypeView data='' purpose={purpose} />
          </div>
          )}
          
           {showEdit && (
          <div className='w-full h-fit bg-gray-300x my-1'>
<AddRoomTypeView data={datas} purpose={purpose} />
          </div>
          )}
