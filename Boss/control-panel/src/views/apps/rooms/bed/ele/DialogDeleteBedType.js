...
const DialogDeleteBedType = ({id}) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_WEB_URL}/admin/bed-type/${id}`, {
        method: 'DELETE',
        headers: {
      ...
      const successMessage = responseData.message || 'Bed Type deleted successfully';
...
export default DialogDeleteBedType