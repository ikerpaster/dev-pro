...
const TableHeader = props => {
  ...
  const { 
    // handleFilter,
     toggle, value,setModalOpenAdmin } = props
  ...
  return (
    <Box sx={{ p: 5, pb: 3, display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center' }}>
        ...
        {/* <AddProType /> */}
        <AddRole />
        {/* <div className='py-2 bg-violet-300 px-3 rounded-lg text-white cursor-pointer shadow-2xl shadow-violet-500' onClick={()=>setModalOpenAdmin(true)} >Add new User </div> */}
        </Grid>
