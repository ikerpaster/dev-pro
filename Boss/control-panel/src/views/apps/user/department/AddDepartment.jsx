...
const AddDepartment = ({id,depDesc,depName,staff}) => {
  // ** States
  ...
  return (
    <div>
        ...
        <div onClick={() => setShow(true)} className='flex gap-1 items-center'>
      ...
      >
        ...
        <span className=''>
          ...
          <Autocomplete
            ...
            renderInput={params => <TextField {...params} size='small' placeholder='Search By Position' />}
